...
class PmEtablissementResourceIT {
    ...
    private static final String DEFAULT_IDENTIFIANT_AI = "AAAAAAAAAA";
    private static final String UPDATED_IDENTIFIANT_AI = "BBBBBBBBBB";
     ...
     */
    public static PmEtablissement createEntity() {
        return new PmEtablissement()
            ...
            .identifiantAI(DEFAULT_IDENTIFIANT_AI)
     ...
     * if they test an entity which requires the current entity.
     */
    public static PmEtablissement createUpdatedEntity() {
        return new PmEtablissement()
            ...
            .identifiantAI(UPDATED_IDENTIFIANT_AI)
            .checked(UPDATED_CHECKED);
    }

    @BeforeEach
    void initTest() {
        pmEtablissement = createEntity();
    }
    ...
    void getAllPmEtablissements() throws Exception {
        ...
        restPmEtablissementMockMvc
            ...
            .andExpect(jsonPath("$.[*].identifiantAI").value(hasItem(DEFAULT_IDENTIFIANT_AI)))
    ...
    void getPmEtablissement() throws Exception {
        ...
        restPmEtablissementMockMvc
            ...
            .andExpect(jsonPath("$.identifiantAI").value(DEFAULT_IDENTIFIANT_AI))
