...
public class PmEtablissementAsserts {
    ...
    public static void assertPmEtablissementUpdatableFieldsEquals(PmEtablissement expected, PmEtablissement actual) {
        assertThat(actual)
            ...
            .satisfies(a -> assertThat(a.getIdentifiantAI()).as("check identifiantAI").isEqualTo(expected.getIdentifiantAI()))
            .satisfies(a -> assertThat(a.getChecked()).as("check checked").isEqualTo(expected.getChecked()));
    }
